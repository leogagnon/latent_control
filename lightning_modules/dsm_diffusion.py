...
class DSMDiffusion(L.LightningModule):
    ...
    def compute_diffusion_loss(
        ...
        if self.model.cfg.class_conditional and self.model.cfg.class_unconditional_prob > 0:
            assert exists(class_id)
            class_unconditional_mask = self.model.class_unconditional_bernoulli.sample(class_id.shape).bool()
